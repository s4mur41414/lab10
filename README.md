...
```cpp
	...
	auto id2 = scheduler.add([](float b, float v){return -4 * a * c;}, b, scheduler.getFutureResult<float>(id1));
...
### Требования и ограничения к заданиям
  ...
  - Возвращаемое значение произвольное, uарантированно [CopyConstructible](https://en.cppreference.com/w/cpp/named_req/CopyConstructible)
